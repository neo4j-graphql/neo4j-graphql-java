...
class RootNodeConnectionEdgeSelection {
    ...
    object Augmentation : AugmentationBase {
        fun generateImplementingTypeEdgeOT(implementingType: ImplementingType, ctx: AugmentationContext): String =
            ctx.getOrCreateObjectType("${implementingType.name}${Constants.OutputTypeSuffix.Edge}") { fields, _ ->
                ...
                ?: throw IllegalStateException("Expected ${implementingType.name}${Constants.OutputTypeSuffix.Edge} to have fields")
    }
}
