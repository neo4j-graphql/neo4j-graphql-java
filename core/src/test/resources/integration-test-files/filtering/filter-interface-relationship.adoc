...
query Actors($title: String) {
  actors(where: {actedIn_SOME: {title_EQ: $title}}) {
    name
    actedIn {
      title
      ... on Movie {
...
----
query Actors($title: String) {
  actors(where: {actedIn_ALL: {title_EQ: $title}}) {
    name
    actedIn {
      title
      ... on Movie {
...
----
query Actors($title: String) {
  actors(where: {actedIn_SINGLE: {title_EQ: $title}}) {
    name
    actedIn {
      title
      ... on Movie {
...
----
query Actors($title: String) {
  actors(where: {actedIn_NONE: {title_EQ: $title}}) {
    name
    actedIn {
      title
      ... on Movie {
