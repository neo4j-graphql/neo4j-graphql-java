...
query Actors($title: String) {
  actors(where: {actedIn_SOME: {Movie: {title_EQ: $title}}}) {
    name
    actedIn {
      ... on Movie {
        title
...
----
query Actors($title: String) {
  actors(where: {actedIn_ALL: {Movie: {title_EQ: $title}}}) {
    name
    actedIn {
      ... on Movie {
        title
...
query Actors($title: String) {
  actors(
    where: {actedIn_ALL: {Movie: {title_EQ: $title}, Series: {title_EQ: $title}}}
  ) {
    name
    actedIn {
      ... on Movie {
...
----
query Actors($title: String) {
  actors(where: {actedIn_SINGLE: {Movie: {title_EQ: $title}}}) {
    name
    actedIn {
      ... on Movie {
        title
...
query Actors($title: String) {
  actors(
    where: {actedIn_NONE: {Movie: {title_EQ: $title}, Series: {title_EQ: $title}}}
  ) {
    name
    actedIn {
      ... on Movie {
