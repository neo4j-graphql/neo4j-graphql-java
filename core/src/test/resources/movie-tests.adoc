...
[source,cypher]
----
MATCH (Movie: Movie) WHERE Movie.title = $movieTitle RETURN Movie { .title, actors: [(Movie)<-[: ACTED_IN]-(MovieActors: Actor) | MovieActors { .name }][0..$movieActorsFirst] } AS Movie
----
