...
CALL {
	...
	RETURN any(var2 IN collect(this0.someTime) WHERE var2 = time($param0)) AS var3
}
WITH *
WHERE var3 = true
RETURN this {
...
CALL {
	WITH this
	MATCH (this1:User)-[this0:LIKES]->(this)
	RETURN any(var2 IN collect(this0._someTimeAlias) WHERE var2 = time($param0)) AS var3
}
WITH *
WHERE var3 = true
RETURN this {
