...
CALL {
	...
	RETURN any(var2 IN collect(this1.someDateTime) WHERE var2 = datetime($param0)) AS var3
}
WITH *
WHERE var3 = true
RETURN this {
...
CALL {
	WITH this
	MATCH (this1:User)-[this0:LIKES]->(this)
	RETURN any(var2 IN collect(this1._someDateTimeAlias) WHERE var2 = datetime($param0)) AS var3
}
WITH *
WHERE var3 = true
RETURN this {
