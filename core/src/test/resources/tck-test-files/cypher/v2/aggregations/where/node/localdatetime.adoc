...
CALL {
	...
	RETURN any(var2 IN collect(this1.someLocalDateTime) WHERE var2 = localdatetime($param0)) AS var3
}
WITH *
WHERE var3 = true
RETURN this {
...
CALL {
	WITH this
	MATCH (this1:User)-[this0:LIKES]->(this)
	RETURN any(var2 IN collect(this1._someLocalDateTimeAlias) WHERE var2 = localdatetime($param0)) AS var3
}
WITH *
WHERE var3 = true
RETURN this {
...
CALL {
	WITH this
	MATCH (this1:User)-[this0:LIKES]->(this)
	RETURN max(this1.someLocalDateTime) = localdatetime($param0) AS var2
}
WITH *
WHERE var2 = true
RETURN this {
...
CALL {
	WITH this
	MATCH (this1:User)-[this0:LIKES]->(this)
	RETURN min(this1.someLocalDateTime) = localdatetime($param0) AS var2
}
WITH *
WHERE var2 = true
RETURN this {
