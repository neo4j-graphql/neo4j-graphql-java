...
CALL {
	WITH this
	MATCH (this)<-[this_connection_jennythis1:ACTED_IN]-(this_Actor:Actor)
	WHERE this_Actor.name = $param2
	WITH {
		screenTime: this_connection_jennythis1.screenTime,
		node: {
			name: this_Actor.name
		}
	} AS edge
