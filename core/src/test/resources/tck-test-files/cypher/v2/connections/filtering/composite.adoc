...
----
{
  movies(where: {title_EQ: "Forrest Gump"}) {
    title
    actorsConnection(
      where: {node: {AND: [{firstName_EQ: "Tom"}, {lastName_EQ: "Hanks"}]}, edge: {AND: [{screenTime_GT: 30}, {screenTime_LT: 90}]}}
    ) {
      edges {
        properties {
          screenTime
...
----
{
  movies(where: {title_EQ: "Forrest Gump"}) {
    title
    actorsConnection(
      where: {node: {NOT: {firstName_EQ: "Tom", lastName_EQ: "Hanks"}}, edge: {NOT: {screenTime_GT: 30, screenTime_LT: 90}}}
    ) {
      edges {
        properties {
          screenTime
...
----
{
  movies(where: {title_EQ: "Forrest Gump"}) {
    title
    actorsConnection(
      where: {OR: [{node: {AND: [{firstName_EQ: "Tom"}, {lastName_EQ: "Hanks"}]}}, {edge: {AND: [{screenTime_GT: 30}, {screenTime_LT: 90}]}}]}
    ) {
      edges {
        properties {
          screenTime
...
----
{
  movies(where: {title_EQ: "Forrest Gump"}) {
    title
    actorsConnection(
      where: {NOT: {OR: [{node: {AND: [{firstName_EQ: "Tom"}, {lastName_EQ: "Hanks"}]}}, {edge: {AND: [{screenTime_GT: 30}, {screenTime_LT: 90}]}}]}}
    ) {
      edges {
        properties {
          screenTime
...
----
{
  movies(where: {title_EQ: "Forrest Gump"}) {
    title
    actorsConnection(
      where: {NOT: {AND: [{OR: [{node: {AND: [{firstName_EQ: "Tom"}, {lastName_EQ: "Hanks"}]}}, {edge: {AND: [{screenTime_GT: 30}, {screenTime_LT: 90}]}}]}, {node: {AND: [{firstName_EQ: "Tommy"}, {lastName_EQ: "Ford"}]}}]}}
    ) {
      edges {
        properties {
          screenTime
