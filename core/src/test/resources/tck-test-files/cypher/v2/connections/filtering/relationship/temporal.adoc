...
----
{
  ...
  "this_connection_actorsConnectionparam1" : "2010-01-01T00:00:00.000Z"
}
----
...
CALL {
	...
	WHERE (this_connection_actorsConnectionthis0.startDate > date($this_connection_actorsConnectionparam0)
		AND this_connection_actorsConnectionthis0.endDateTime < datetime($this_connection_actorsConnectionparam1))
	WITH {
