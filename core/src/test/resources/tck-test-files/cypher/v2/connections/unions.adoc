...
----
{
  authors {
    name
    publicationsConnection(
      where: {Book: {node: {title_EQ: "Book Title"}}, Journal: {node: {subject_EQ: "Journal Subject"}}}
    ) {
      edges {
        properties {
          words
...
----
{
  authors {
    name
    publicationsConnection(
      where: {Book: {edge: {words_EQ: 1000}, node: {title_EQ: "Book Title"}}, Journal: {edge: {words_EQ: 2000}, node: {subject_EQ: "Journal Subject"}}}
    ) {
      edges {
        properties {
          words
