...
CALL {
    ...
    CALL {
        WITH *
        MATCH (this)-[this0:OWNS]->(this1:Character)
        WITH this1 { .id, __resolveType: "Character", __id: id(this1) } AS this1
        RETURN this1 AS var2
        UNION
        WITH *
        MATCH (this)-[this3:OWNS]->(this4:Tile)
        WITH this4 { .id, __resolveType: "Tile", __id: id(this4) } AS this4
