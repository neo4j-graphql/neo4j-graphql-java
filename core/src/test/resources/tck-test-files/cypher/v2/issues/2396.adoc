...
WHERE (this.price >= $param0
	AND single(this3 IN [(this)-[:HAS_VALUATION]->(this3) | this3]
	WHERE single(this0 IN [(this3)-[:VALUATION_FOR]->(this0) | this0]
	WHERE (this0.area >= $param1
		AND this0.floor >= $param2
		AND this0.estateType IN $param3
		AND single(this2 IN [(this0)-[:HAS_ADDRESS]->(this2) | this2]
		WHERE single(this1 IN [(this2)-[:HAS_POSTAL_CODE]->(this1) | this1]
		WHERE this1.number IN $param4)))))
