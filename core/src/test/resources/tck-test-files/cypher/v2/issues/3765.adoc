...
{
  posts(
    where: {OR: [{content_EQ: "stuff", alternateContent_EQ: "stuff2"}, {content_EQ: "stuff3"}]}
  ) {
    content
  }
}
...
{
  posts(
    where: {likes_SOME: {name_EQ: "stuff"}, likes_ALL: {otherName_EQ: "stuff2"}}
  ) {
    content
  }
}
...
{
  posts(
    where: {OR: [{likes_SOME: {name_EQ: "stuff"}}, {likes_ALL: {otherName_EQ: "stuff2"}}, {likes_SOME: {otherName_EQ: "stuff3"}}]}
  ) {
    content
  }
}
