...
= @filterable directive -> snapshot tests -> on INTERFACE RELATIONSHIP FIELD, (aggregation does not exists on abstract types) -> default arguments should disable aggregation
