...
input MovieWhere {
  ...
  NOT: MovieWhere
  OR: [MovieWhere!]
  genres: GenreWhere @deprecated(reason : "Do not use")
  genresAggregate: MovieGenresAggregateInput @deprecated(reason : "Do not use")
  genresConnection: MovieGenresConnectionWhere @deprecated(reason : "Do not use")
  ...
  genresConnection_NOT: MovieGenresConnectionWhere @deprecated(reason : "Do not use")
  ...
  genres_NOT: GenreWhere @deprecated(reason : "Do not use")
