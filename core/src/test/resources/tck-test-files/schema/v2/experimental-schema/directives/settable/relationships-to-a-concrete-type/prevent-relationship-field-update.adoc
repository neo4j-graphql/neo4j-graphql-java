...
= @settable -> Relationships to a concrete type -> Prevent relationship field update
...
type Actor @query(aggregate: true) {
  name: String!
  actedIn: [Movie!]! @relationship(type: "ACTED_IN", direction: OUT) @settable(onCreate: true, onUpdate: false)
}
----
