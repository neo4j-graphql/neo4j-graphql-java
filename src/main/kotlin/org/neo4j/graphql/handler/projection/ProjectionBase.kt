...
open class ProjectionBase(val metaProvider: MetaProvider) {
    ...
    fun where(variable: String, field: FieldDefinition, type: NodeFacade, arguments: List<Argument>, ctx: Translator.Context): Cypher {
    ...
    fun projectFields(variable: String, field: Field, nodeType: NodeFacade, ctx: Translator.Context, variableSuffix: String?): Cypher {
    ...
    private fun projectField(variable: String, field: Field, type: NodeFacade, ctx: Translator.Context, variableSuffix: String?): Cypher {
    ...
    private fun projectFragment(fragmentTypeName: String?, type: NodeFacade, variable: String, ctx: Translator.Context, variableSuffix: String?, selectionSet: SelectionSet): List<Cypher> {
    ...
    private fun projectRelationship(variable: String, field: Field, fieldDefinition: FieldDefinition, parent: NodeFacade, ctx: Translator.Context, variableSuffix: String?): Cypher {
    ...
    private fun projectListComprehension(variable: String, field: Field, fieldDefinition: FieldDefinition, ctx: Translator.Context, expression: Cypher, variableSuffix: String?): Cypher {
    ...
    private fun projectRelationshipParent(variable: String, field: Field, fieldDefinition: FieldDefinition, ctx: Translator.Context, variableSuffix: String?): Cypher {
        val fieldObjectType = metaProvider.getNodeType(fieldDefinition.type.name()) ?: return Cypher.EMPTY
    ...
    private fun projectRichAndRegularRelationship(variable: String, field: Field, fieldDefinition: FieldDefinition, parent: NodeFacade, ctx: Translator.Context): Cypher {
        val fieldType = fieldDefinition.type
